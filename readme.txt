...
* Fixed stale cross-promo card in the **More by Ray Bogman** tab: `RayAI – Content Orchestrator` → `Ray Bogman AI Content Orchestrator` (matches the canonical name in the Content Orchestrator plugin folder).
